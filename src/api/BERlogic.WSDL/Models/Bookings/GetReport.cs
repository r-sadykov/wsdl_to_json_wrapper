...
{
    /// <summary>
    /// Used in the <see cref="GetReport"/> method to send the request.
    /// </summary>
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.2")]
    [System.ServiceModel.MessageContractAttribute(WrapperName = "getReport", WrapperNamespace = "http://partner.v3.webservice.test.de/", IsWrapped = true)] //DevSkim: ignore DS137138
    public partial class GetReport
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GetReport"/> class.
        /// </summary>
        public GetReport()
        {
        }
        ...
        /// <param name="searchParameters">The search parameters for the booking search.</param>
        public GetReport(BerlogicAgent agent, BookingSearchParameter searchParameters)
        {
